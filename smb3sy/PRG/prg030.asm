...
Map_Y_Starts:
	; Map Y start positions, World 1-8
...
;these are the green coins of each tileset
GreenCoins:	.byte $FF, $81, $A0 ,$8A, $91, $8D, $8A, $8A, $8A, $A0, $86, $8D, $91, $8D, $8A

Level_DoCoin:
	LDA Level_Tile_GndL,X
	CMP #TILEA_COIN
	BEQ Level_CollectCoin	 ; If Player is touching coin, jump to Level_CollectCoin
	JMP PRG008_B604X
Level_CollectCoin:
	...
	; Logic to handle green coins (custom)
Level_DoGreenCoin:
	LDA Level_Tile_GndL,X
	LDY Level_Tileset
	CMP GreenCoins,Y
	BEQ Level_CollectGreenCoin
	JMP PRG008_B623
Level_CollectGreenCoin:
	LDA Player_GreenCoinCount+1
	CMP #$01
	BCS Level_NotAllGreenCoins ; skip if got green coin this frame

	INC Player_GreenCoinCount  ;increment green coin count 

	JSR Score_FindFreeSlot
	LDA Player_GreenCoinCount
	ADC #$05
	STA Scores_Value,Y
	LDA #$30
	...
	LDA Player_GreenCoinCount
	CMP #$08 ; check if collected 8 green coins
	BNE Level_NotAllGreenCoins
	
	LDA Sound_QLevel1
	ORA #SND_LEVEL1UP
	STA Sound_QLevel1
Level_NotAllGreenCoins:
	INC Player_GreenCoinCount+1
